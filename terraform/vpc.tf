...
# Private subnets — app servers live here, no direct internet exposure
...
# NAT Gateway allows private-subnet instances to reach the internet (e.g. for git pull, pip install)
